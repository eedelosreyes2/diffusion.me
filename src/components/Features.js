    ...
    render() {
        return (<div className="features-container">
            ...
            <div className="features-div">
                ...
                <h4>By using our tool- you can set-up your content to create magic later.</h4>
                <h4>When you find your content  you can add descriptions, give your quick thoughts, add titles, and curate based on your tastes.</h4>
            </div>
        </div>);
    }
}